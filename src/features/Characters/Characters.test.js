...
const response = {
  ...
  etag: "ca3d422e4caf5366c5e2f16268a11ffe022a8dbe",
  data: {
    offset: 0,
    limit: 20,
    total: 1493,
        ...
        urls: [
          {
            type: "detail",
            url:
              "http://marvel.com/comics/characters/1011334/3-d_man?utm_campaign=apiRef&utm_source=680e11e6ae10cd6d8b0dbedc8514a138"
          },
          {
            type: "wiki",
            url:
              "http://marvel.com/universe/3-D_Man_(Chandler)?utm_campaign=apiRef&utm_source=680e11e6ae10cd6d8b0dbedc8514a138"
          },
          {
            type: "comiclink",
            url:
        ...
        urls: [
          {
            type: "detail",
            url:
              "http://marvel.com/comics/characters/1017100/a-bomb_has?utm_campaign=apiRef&utm_source=680e11e6ae10cd6d8b0dbedc8514a138"
          },
          {
            type: "comiclink",
            url:
        ...
        urls: [
          {
            type: "detail",
            url:
              "http://marvel.com/comics/characters/1009144/aim.?utm_campaign=apiRef&utm_source=680e11e6ae10cd6d8b0dbedc8514a138"
          },
          {
            type: "wiki",
            url:
              "http://marvel.com/universe/A.I.M.?utm_campaign=apiRef&utm_source=680e11e6ae10cd6d8b0dbedc8514a138"
          },
          {
            type: "comiclink",
            url:
...
test("Get list of Characters from api", async () => {
  ...
  const cards = await findAllByTestId("character-card");
